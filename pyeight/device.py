...
from pyeight.constants import (
    DEFAULT_TIMEOUT, CLIENT_HEADERS, CLIENT_URL, __version__)
...
class EightSleep(object):
    ...
    async def fetch_device_list(self):
        ...
        url = '{}/users/me'.format(CLIENT_URL)
    ...
    async def update_device_data(self):
        ...
        url = '{}/devices/{}'.format(CLIENT_URL, self.deviceid)
